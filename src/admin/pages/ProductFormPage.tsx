  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 space-y-5">
        ...
        <div className="rounded-2xl border border-amber-200/80 bg-amber-50/40 p-5 dark:border-amber-900/40 dark:bg-amber-950/10">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-amber-950 dark:text-amber-300 flex items-center gap-2">
              <span>🔍</span> SEO & Search Engine Optimization (Optional)
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Customize title and description for Google Search & AI Overviews. Fallback defaults are auto-generated if left blank.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">Custom SEO Title</label>
              ...
              <input
                ...
                placeholder="e.g. Pyrite Stone AAA Grade | Natural Crystal Cluster | Golden Meraki"
                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
              />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">Custom Meta Description</label>
              ...
              <textarea
                ...
                placeholder="e.g. Buy certified natural AAA grade raw pyrite stone cluster at Golden Meraki Gems. Attract wealth, financial growth & energetic protection."
                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
              />
            </div>

            <div>
              <label className="mb-1 block text-xs font-semibold text-slate-700 dark:text-slate-300">Meta Keywords (Comma separated)</label>
              <input
                type="text"
                value={seoKeywords}
                onChange={(e) => setSeoKeywords(e.target.value)}
                placeholder="e.g. pyrite stone, fool gold, crystal for wealth, raw pyrite cluster"
                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
              />
            </div>
          </div>
