    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-6">
        <div className="flex items-center gap-6 pb-6 border-b border-slate-100 dark:border-slate-800">
          ...
          />
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">{user?.name || 'Manoj Admin'}</h3>
            <p className="text-xs text-slate-400 flex items-center gap-1.5 mt-1">
              <Mail className="w-3.5 h-3.5" />
              <span>{user?.email || 'admin@goldenmeraki.com'}</span>
            </p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              defaultValue={user?.name || 'Manoj Admin'}
          ...
          <div>
            ...
            <input
              type="email"
              readOnly
              value={user?.email || 'admin@goldenmeraki.com'}
